...
enum {
    ...
    CAMERA_MSG_PANO_UI_IMAGE = 0x4000,
    CAMERA_MSG_PANO_STITCH_IMAGE = 0x8000,
    CAMERA_MSG_PANO_META_DATA = 0x10000,
...
enum {
    ...
    CAMERA_META_DATA_EV = 0x004,     //EV data
};
...
enum {
    ...
    CAMERA_CMD_START_PANORAMA = 102,
    CAMERA_CMD_STOP_PANORAMA = 103,
};
